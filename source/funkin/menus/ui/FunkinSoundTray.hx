...
class FunkinSoundTray extends FlxSoundTray
{
	...
	public function new()
	{
		...
		text.defaultTextFormat = new TextFormat(Paths.getFontName(Paths.font("vcr.ttf")), 8, 0xffffff);
		text.setTextFormat(new TextFormat(Paths.getFontName(Paths.font("vcr.ttf")), 8, 0xffffff));
