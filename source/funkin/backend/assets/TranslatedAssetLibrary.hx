...
class TranslatedAssetLibrary extends AssetLibrary implements ICustomAssetLibrary
{
	public var libName:String;
	public var basePath:String;
	public var prefix:String = TranslationUtil.LANG_FOLDER + "/";

	public var forLibrary:ICustomAssetLibrary;
	...
	{
		basePath = prefix + (libName = (value != null ? value : Flags.DEFAULT_LANGUAGE)) + "/";
		return libName;
	}

	public function new(lib:ICustomAssetLibrary, ?langFolder:String)
	{
		super();
		this.forLibrary = lib;
	...
	private inline function getAssetPath():String // because of the ICustomAssetLibrary  - Nex
		return basePath;
	...
	{
		// Refactored to only check the wrapped library
		var lib = forLibrary;
